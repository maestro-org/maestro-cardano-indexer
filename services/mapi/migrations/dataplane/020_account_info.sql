-- Adapted from the Koios account_info function in koios-artifacts
-- (https://github.com/cardano-community/koios-artifacts, CC-BY-4.0),
-- modified to return additional delegation and balance detail used by the
-- account endpoints. Applied after the upstream install, alongside the
-- account_history override.
CREATE OR REPLACE FUNCTION grest.account_info_v2(_stake_addresses text [])
RETURNS TABLE (
...
COMMENT ON FUNCTION grest.account_info_v2 IS 'Get the account info for given stake addresses'; -- noqa: LT01
